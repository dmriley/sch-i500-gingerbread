...
#ifndef __UI_DEVICE_H_
#define __UI_DEVICE_H_
...
#define SELECT_HOME			-5
#define SELECT_BACK			-6

#define ITEM_REBOOT          0
#define ITEM_APPLY_SDCARD    1
#define ITEM_WIPE_DATA       2
#define ITEM_WIPE_CACHE      3
#define ITEM_TEST_BACKUP     4
#define ITEM_TEST_RESTORE    5
